...
* **gitea**: [Site](https://gitea.com/en-us/) [Docker](docker.gitea.com/gitea:1.25.1-rootless) [Rootless Guide](https://docs.gitea.com/installation/install-with-docker-rootless)
